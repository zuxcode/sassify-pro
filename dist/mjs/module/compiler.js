...
export default class Compiler {
    static preCompile(props) {
        const { sourceFile, outputDirectory = props.outputDirectory ?? 'public', style = props.style ?? 'expanded', sourceMap = true, quietDeps = true, } = props;
    ...
    static compileSass(props) {
        ...
        const isValidPath = (filePath) => !searchWhiteSpaceEmptyString.test(filePath);
        try {
