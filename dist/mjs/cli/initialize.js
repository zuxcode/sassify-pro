...
export default class Initialize {
    static message() {
        ...
        console.log(chalk.bgHex('#ff0000').whiteBright(` ${pkg.name} `), chalk.gray(`v${pkg.version} by ${pkg.author.match(/^codeauthor1/)}`));
    ...
    static version() {
        const pkg = PackageJson.readPkg();
        console.log(chalk.bgHex('#ff0000').whiteBright(` ${pkg.name} `), chalk.gray(`v${pkg.version}`));
    }
    static sassifyproInit() {
            ...
            readFile(configPath, 'utf8', (err, data) => {
                ...
                try {
                    ...
                    readConfig((error, config) => {
                        ...
                        writeFile(configPath, updatedJsonData, 'utf8', (e) => {
                            if (e) {
                                spinner.error({
